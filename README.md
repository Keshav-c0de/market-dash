...
1. Analytics & Metrics
   ...
   Relative Strength Chart: 30-day cumulative return comparison vs. Index.

3. Portfolio Management (CRUD)

    Add/Remove UI: Streamlit forms to edit portfolio.csv directly.
    Data Validation: Logic to ensure ticker symbols and prices are valid.

4. Market Intelligence

    Web Scraper: Multi-source news fetcher (Requests/BeautifulSoup).
    Smart Filter: Auto-link news articles to specific stocks in your portfolio.
